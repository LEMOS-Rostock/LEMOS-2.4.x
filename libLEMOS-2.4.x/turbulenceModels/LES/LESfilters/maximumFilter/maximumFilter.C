...
defineTypeNameAndDebug(maximumFilter, 0);
addToRunTimeSelectionTable(LESfilter, maximumFilter, dictionary);
...
maximumFilter::maximumFilter(const fvMesh& mesh, const dictionary& dict)
:
    LESfilter(mesh),
    addressing_(centredCPCCellToCellExtStencilObject::New(mesh))
{}
...
void maximumFilter::read(const dictionary& dict)
{}

void maximumFilter::updateStencil()
{
...
Foam::tmp<Foam::volVectorField> Foam::maximumFilter::operator()
(
...
Foam::tmp<Foam::volScalarField> Foam::maximumFilter::operator()
(
...
Foam::tmp<Foam::volSymmTensorField> Foam::maximumFilter::operator()
(
...
Foam::tmp<Foam::volTensorField> Foam::maximumFilter::operator()
(
