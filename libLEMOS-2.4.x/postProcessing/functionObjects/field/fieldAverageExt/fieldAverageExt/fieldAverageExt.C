...
namespace Foam
{
defineTypeNameAndDebug(fieldAverageExt, 0);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::fieldAverageExt::resetFields()
{
    forAll(faItems_, i)
    {
        if (faItems_[i].mean())
...
void Foam::fieldAverageExt::initialize()
{
    resetFields();
    ...
    forAll(faItems_, fieldI)
    {
        ...
        {
            WarningIn("void Foam::fieldAverageExt::initialize()")
...
void Foam::fieldAverageExt::calcAverages()
{
    if (!initialised_)
    {
        initialize();
...
void Foam::fieldAverageExt::writeAverages() const
{
...
void Foam::fieldAverageExt::writeAveragingProperties() const
{
...
void Foam::fieldAverageExt::readAveragingProperties()
{
    totalIter_.clear();
...
Foam::fieldAverageExt::fieldAverageExt
(
    const word& name,
    ...
    totalTime_()
{
    ...
    else
    {
        ...
        WarningIn
        (
            "fieldAverageExt::fieldAverageExt"
            "("
                "const word&, "
...
void Foam::fieldAverageExt::read(const dictionary& dict)
{
    if (active_)
    {
        initialised_ = false;
...
void Foam::fieldAverageExt::execute()
{
    if (active_)
    {
        calcAverages();
...
void Foam::fieldAverageExt::timeSet()
{}


void Foam::fieldAverageExt::write()
{
    if (active_)
    {
        writeAverages();
...
void Foam::fieldAverageExt::updateMesh(const mapPolyMesh&)
{
    // Do nothing
}


void Foam::fieldAverageExt::movePoints(const polyMesh&)
{
    // Do nothing
}
