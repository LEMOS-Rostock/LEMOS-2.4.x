...
template<class Type>
void Foam::fieldAverageExt::addMeanFieldType(const label fieldI)
{
...
template<class Type>
void Foam::fieldAverageExt::addMeanField(const label fieldI)
{
...
void Foam::fieldAverageExt::addPrime2MeanFieldType(const label fieldI)
{
    const word& fieldName = faItems_[fieldI].fieldName();
    const word& meanFieldName = faItems_[fieldI].meanFieldName();
...
template<class Type1, class Type2>
void Foam::fieldAverageExt::addPrime2MeanField(const label fieldI)
{
    ...
    if (faItems_[fieldI].prime2Mean())
    {
        ...
        if (!faItems_[fieldI].mean())
        {
            FatalErrorIn
            (
                "void Foam::fieldAverageExt::addPrime2MeanField(const label) const"
            )
...
template<class Type>
void Foam::fieldAverageExt::calculateMeanFieldType(const label fieldI) const
{
    const word& fieldName = faItems_[fieldI].fieldName();
...
template<class Type>
void Foam::fieldAverageExt::calculateMeanFields() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> volFieldType;
    typedef GeometricField<Type, fvsPatchField, surfaceMesh> surfFieldType;
...
template<class Type1, class Type2>
void Foam::fieldAverageExt::calculatePrime2MeanFieldType(const label fieldI) const
{
    const word& fieldName = faItems_[fieldI].fieldName();
...
template<class Type1, class Type2>
void Foam::fieldAverageExt::calculatePrime2MeanFields() const
{
    typedef GeometricField<Type1, fvPatchField, volMesh> volFieldType1;
    typedef GeometricField<Type1, fvsPatchField, surfaceMesh> surfFieldType1;
...
template<class Type1, class Type2>
void Foam::fieldAverageExt::addMeanSqrToPrime2MeanType(const label fieldI) const
{
    const word& fieldName = faItems_[fieldI].fieldName();
...
template<class Type1, class Type2>
void Foam::fieldAverageExt::addMeanSqrToPrime2Mean() const
{
    typedef GeometricField<Type1, fvPatchField, volMesh> volFieldType1;
    typedef GeometricField<Type1, fvsPatchField, surfaceMesh> surfFieldType1;
...
template<class Type>
void Foam::fieldAverageExt::writeFieldType(const word& fieldName) const
{
    if (obr_.foundObject<Type>(fieldName))
    {
...
template<class Type>
void Foam::fieldAverageExt::writeFields() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> volFieldType;
    typedef GeometricField<Type, fvsPatchField, surfaceMesh> surfFieldType;
